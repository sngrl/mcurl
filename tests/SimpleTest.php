...
class SimpleTest extends CaseTest
{
    ...
    {
        $urls = array($this->url('/simple-sleep-4.txt'), $this->url('/simple-sleep-1.txt'), $this->url('/simple-sleep-2.txt'), $this->url('/simple-sleep-3.txt'));
        $time_begin = time();
        $results = $this->req->get($urls);
        $time_end = time();
        $i = 1;
    ...
    public function testGetSynchron()
    {
        $req = $this->createReq();
        $req->setMaxRequest(1);
        $urls = array($this->url('/simple-sleep-1.txt'), $this->url('/simple-sleep-2.txt'), $this->url('/simple-sleep-3.txt'));
        $time_begin = time();
